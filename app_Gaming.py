from Laptop_Gaming import LaptopGaming
...
class App:
    def __init__(self, root):
        self.root = root        
        self.laptops = []
        self.imagenes = [".\\img\\descarga.jpg",".\\img\\descarga (1).jpg",".\\img\\descarga (2).jpg",".\\img\\descarga (3).jpg",".\\img\\descarga (4).jpg",]
    ...
    def agregar_laptop(self):
        nueva_laptop = LaptopGaming(self.marca.get(), self.procesador.get(), self.memoria.get(), self.tar_grafica.get(), self.precio.get())
